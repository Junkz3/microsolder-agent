// Entry point for the web app. Imports focused modules (router, …) and
// keeps the bootstrap + graph D3 code here for now — subsequent refactors
// will extract home, graph, and boardview-tweaks into their own modules.
...
// Registered BEFORE the global ESC/Cmd+K handler below, so we can intercept
// those keys while the modal is open without closing the Inspector or stealing focus.
